...
競プロ（AtCoder / ICPC）の学習・リファレンス資料。

## 学習ロードマップ
段階的に「解ける範囲」を広げ、解法をコードにする力を鍛えるための資料群。

| doc | 内容 |
| --- | --- |
| [problem-set.md](./problem-set.md) | **レベル別 問題集**。ICPC 予選 N 問目 = level N。Level 1〜7 の精選問題（AtCoder / AOJ） |
...
| doc | 内容 |
| --- | --- |
| [typical-patterns.md](./typical-patterns.md) | 問題文の特徴 → 手法の逆引き表、考察の定石 |
| [constraints-complexity.md](./constraints-complexity.md) | 制約 → 計算量 → アルゴリズムの対応表 |
| [kotlin-cheatsheet.md](./kotlin-cheatsheet.md) | Kotlin 競プロチートシート |
